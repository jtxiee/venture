                            ...
                            <h6 class="mb-3"> BOOKING DETAILS </h6>
                             <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <h6 class="mb-3 text-danger" id="pay_info">Provie check-in & check-out date !</h6>
            ...
            function check_availability()
            {
                ...
                if(checkin_val!='' && checkout_val!='')
                {
                    ...
                    xhr.onload = function() 
                    {
                        ...
                        {
                            pay_info.innerHTML = "No .of Days: "+data.days+"<br>Total Amount to Pay: "+data.payment+" VNĐ";
