...
<head>
    ...
    <title><?php echo $settings_r['site_title'] ?> - KhachSan</title>
</head>
...
<body class="bg-light">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-white rounded shadow">
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            ...
                            <!-- Guests -->
                            <div class="border bg-light p-3 rounded mb-3">
                                <!-- <h5 class="mb-3" style="font-size: 18px;">KHÁCH</h5> -->
                                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                                    <span>GUEST</span>
                            ...
                            <!-- Add Search by Name Input Field -->
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                                    <span>ENTER NAME</span>
                                    <button id="name_search_btn" onclick="name_search_clear()" class="btn shadow-none btn-sm text-secondary d-none">Reset</button>
                                </h5>
                                <input type="text" id="search_name" class="form-control shadow-none mb-3" placeholder="Nhập tên phòng" oninput="name_search_filter()">
                            </div>
                        </div>
                    </div>
                </nav>
    ...
    <script>
        ...
        function fetch_rooms() {
            ...
            xhr.open("POST", "ajax/rooms.php?fetch_rooms&chk_avail=" + chk_avail + "&guests=" + guests + "&facility_list=" + facility_list + "&name_search=" + name_search, true);
