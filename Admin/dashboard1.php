...
<body class="bg-light">
    ...
    COUNT(CASE WHEN booking_status='booker' AND arrival=0 THEN 1 END) AS `new_bookings`,
    ...
    FROM `rating_review1` WHERE `seen`=0 "));
            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="row mb-4">
                    <div class="col-md-3 mb-4">
                        <a href="new_bookings1.php" class="text-decoration-none">
                    ...
                    <div class="col-md-3 mb-4">
                        <a href="refund_bookings1.php" class="text-decoration-none">
                    ...
                    <div class="col-md-3 mb-4">
                        <a href="rate_review1.php" class="text-decoration-none">
                            <div class="card text-center text-info p-3">
                                <h6>Rating & Review</h6>
                ...
                <div class="row mb-3">
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-primary p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="total_amt">0 VNĐ</h4>
                        </div>                      
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-success p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="active_amt">0 VNĐ</h4>
                        </div>                      
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-danger p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="cancelled_amt">0 VNĐ</h4>
                        </div>                      
                    </div>
                </div>
