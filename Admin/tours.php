...
<body class="bg-light">
                ...
                <div class="card border-0 shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="text-end mb-4">
                            <button type="button" class="btn btn-dark shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#add-tour">
    ...
    <!-- Add tour modal -->
    <div class="modal fade" id="add-tour" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- Edit tour modal -->
    <div class="modal fade" id="edit-tour" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
    ...
    <!-- Manage tour images modal -->
    <div class="modal fade" id="tour-images" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
