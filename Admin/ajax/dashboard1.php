...
if(isset($_POST['booking_analytics']))
{
    ...
    $result = mysqli_fetch_assoc(mysqli_query($con,"SELECT 
        ...
        COUNT(CASE WHEN booking_status='booker' AND arrival=1 THEN 1 END) AS `active_bookings`,
        SUM(CASE WHEN booking_status='booker' AND arrival=1 THEN `trans_amt` END) AS `active_amt`,
