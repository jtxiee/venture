        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-2" href="tour.php">TOUR</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex">
                        ...
                        if (isset($_SESSION['login']) && $_SESSION['login'] == true) {
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-outline-dark shadow-none dropdown-toggle" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                                    <img src="$path$_SESSION[uPic]" style="width: 25px; height:30px;" class="me-1 rounded-circle">
                                    $_SESSION[uName]
                                </button>
                                <ul class="dropdown-menu dropdown-menu-lg-end">
                                    <li><a class="dropdown-item" href="profile.php">Profile</a></li>
                                    <li><a class="dropdown-item" href="bookings.php">Bookings Hotel</a></li>
                                    <li><a class="dropdown-item" href="bookings1.php">Bookings Tour</a></li>
                    ...
                    else
                    {
                        echo<<<data
                            ...
                            <button type="button" class="btn btn-outline-dark shadow-none me-lg-2 me-3" data-bs-toggle="modal" data-bs-target="#dangnhapmodal">
                            Login</button>
                ...
                <form id="login-form">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input name="email_mob" type="text" class="form-control shadow-none">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Passsword</label>
                            <input name="pass" type="password" required class="form-control shadow-none">
                        </div>
                ...
                <form id="register-form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <span class="badge bg-light text-dark mb-3 text-wrap lh-base">
                            Lưu ý: Thông tin chi tiết của bạn phải khớp với giấy tờ tùy thân (hộ chiếu, giấy phép lái
                            xe, v.v. sẽ được yêu cầu khi nhận phòng.)
                        </span>
                        <div class="container-fluid">
                            <div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="forgot-form">
                    <div class="modal-header">
                        <h5 class="modal-title d-flex align-items-center">
                            <i class="bi bi-person-circle fs-3 me-2"></i> Forgot Passsword
                        </h5>
                    </div>
                    <div class="modal-body">
                        <div class="mb-4">
                            <span class="badge bg-light text-dark mb-3 text-wrap lh-base">
                                Lưu ý: A link will be sent to your email to reset your password!
                            </span>
                            <br>
                            <label class="form-label">Email</label>
                        ...
                        <div class=" text-end">
                            <button type="button" class="btn shadow-none p-0 m-2 " data-bs-toggle="modal" data-bs-target="#dangnhapmodal" data-bs-dismiss="modal">
                                CANCEL
                            </button>
