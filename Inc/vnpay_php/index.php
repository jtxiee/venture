<?php 
    ...
    $uPhone = isset($_SESSION['uPhone']) ? $_SESSION['uPhone'] : '';
    $payment = isset($_SESSION['room']['payment']) ? $_SESSION['room']['payment'] : '';
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <form action="/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="<?php echo htmlspecialchars($payment); ?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label >Họ tên (*)</label>
                        <input class="form-control" id="txt_billing_fullname" name="txt_billing_fullname" type="text" value="<?php echo htmlspecialchars($uName); ?>"/>
                    </div>
                    <div class="form-group">
                        <label >Email (*)</label>
