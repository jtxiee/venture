...
<body class="bg-light">
        ...
        <div class="row">
            ...
            while ($room_data = mysqli_fetch_assoc($room_res)) {
                ...
                if (!$settings_r['shutdown']) {
                    ...
                    $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm text-white custom-bg shadow-none'>Đặt Ngay</button>";
                }
                ...
                if ($rating_fectch['avg_rating'] != NULL) {
                    ...
                    <h6 class='mb-1'>Đánh giá</h6>
                    <span class='badge rounded-pill bg-light'>";
                    for ($i = 0; $i < $rating_fectch['avg_rating']; $i++) {
                            ...
                            <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-evenly mb-2">
                                        $book_btn
                                        <a href="room_details.php?id=$room_data[id]" class="btn btn-sm btn-outline-dark shadow-none">Xem Chi Tiết</a>
                                    </div>
                                </div>
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
            ...
            ?>
            <div class="col-lg-12 text-center mt-5">
                <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More FACILITES >>></a>
            </div>
        </div>
            ...
            <div class="swiper-wrapper mb-5">
                ...
                if (mysqli_num_rows($review_res) == 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($review_res)) {
                        // Tạo các ngôi sao dựa trên giá trị đánh giá
                        $stars = "";
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
                <iframe class="w-100 rounded" height="320px" src="<?php echo $contact_r['jframe'] ?>" loading="lazy"></iframe>
            </div>
                ...
                <form id="recovery-form">
                    <div class="modal-header">
                        <h5 class="modal-title d-flex align-items-center">
                            <i class="bi bi-shield-lock fs-3 me-2"></i> Set up New Passsword
                        </h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class=" text-end">
                            <button type="button" class="btn shadow-none m-2 " data-bs-dismiss="modal">CANCEL</button>
    ...
    <script>
        ...
        recovery_form.addEventListener('submit', (e) => {
            ...
            xhr.onload = function() {
                ...
                {
                    alert('success', "Account reset success");
                    recovery_form.reset();
                }
            }
            xhr.send(data);
