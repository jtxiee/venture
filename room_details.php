                        ...
                        if(!$settings_r['shutdown'])
                            {
                                ...
                                echo <<<book
                                            <button onclick='checkLoginToBook($login,$room_data[id])' class="btn w-100 text-white custom-bg shadow-none mb-1">Đặt Ngay</button>
                                        book;
