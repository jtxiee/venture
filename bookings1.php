        ...
        <div class="row">
            ...
            while ($data = mysqli_fetch_assoc($result)) {
                ...
                if ($data['booking_status'] == 'booker') {
                    ...
                    if ($data['arrival'] == 1) {
                        $btn = "<a href='generate_pdf1.php?gen_pdf&id=$data[booking_id]' class='btn btn-dark btn-sm shadow-none'>Download PDF</a>";
                        if ($data['rate_review'] == 0) {
                            $btn .= "<button type='button' onclick='review_tour($data[booking_id],$data[tour_id])' data-bs-toggle='modal' data-bs-target='#reviewmodal' class='btn btn-dark btn-sm shadow-none ms-2'>Rate & Review</button>";
                        }
                    } else {
                ...
                echo <<<bookings
                        <div class='col-md-4 px-4 mb-4'>
                            <div class='bg-white p-3 rounded shadow-sm'>
                                <h5 class='fw-bold'>$data[tour_name]</h5>
                                <p>$data[price] VNĐ/Đêm</p>
                                <p>
                                    <b>Amount: </b> $data[price] VNĐ <br>
    ...
    <script>
        function cancel_booking(id) {
            if (confirm('Are you sure to cancel booking?')) {
                ...
                xhr.open("POST", "ajax/cancel_booking1.php", true);
        ...
        function review_tour(bid, rid) {
            review_form.elements['booking_id'].value = bid;
            review_form.elements['tour_id'].value = rid;
        }
        ...
        review_form.addEventListener('submit', function(e) {
            ...
            data.append('tour_id', review_form.elements['tour_id'].value);
            ...
            xhr.onload = function() {
                if (this.responseText == '1') {
                    window.location.href = 'bookings1.php?review_status=true';
                } else {
